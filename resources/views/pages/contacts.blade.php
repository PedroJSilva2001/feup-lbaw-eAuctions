...
<div class="container">
    ...
    <div class="row text-center mb-5">
        <h2 class="h1-responsive text-center" style="font-weight: bold">Contact us</h2>
    </div>
    
    <div class="card " style="background-color: #f1f1f1; border: 1.5px solid var(--dark-blue);">
        <div class="card-body">
    ...
    <div class="text-center pt-5">
        ...
        <a class="btn btn-lg text-dark" role="button" href="#!">
